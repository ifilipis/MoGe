...
@click.option('--guided_steps', type=int, default=500, help='Optimizer steps for guided internal feature-bias optimization.')
@click.option('--guided_lr', type=float, default=0.05, help='Learning rate for guided depth residual optimization.')
@click.option('--guided_depth_weight', type=float, default=10000.0, help='Masked-region weight for fitting user-provided depth.')
...
@click.option('--guided_target_normal_weight', type=float, default=0.2, help='Masked-region weight for fitting normals derived from the user-provided depth.')
...
@click.option('--guided_layer_levels', type=str, default='0,2', help='Comma-separated MoGe neck layer indices receiving trainable additive signals.')
